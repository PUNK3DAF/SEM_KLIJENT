...
public class UpravljajMestimaController {
    ...
    public void loadMesta() {
        try {
            ...
            UIHelper.showOperationError(forma, "Sistem ne može da učita mesta", e);
        }
    }
    ...
    private void addMesto() {
        ...
        if (naziv == null || naziv.trim().isEmpty()) {
            UIHelper.showOperationError(forma, "Sistem ne može da kreira mesto", "Naziv ne sme biti prazan");
            return;
        }
        ...
        try {
            ...
            UIHelper.showOperationError(forma, "Sistem ne može da kreira mesto", ex);
        }
    }
}
